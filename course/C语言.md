...
- 循环执行
  ...
  - break和continue
## 2.18 算法题解题思路
1. 尝试自己去编程解决它，但要意识到大部份人都是自己无法解决的，这时不要气馁，如果15分钟还想不出来，此时建议看答案
2. 如果解决不了，就看答案。关键是把答案看懂，这个要花费很大的精力，也是学习的重点。看懂一个程序要分三步：流程、每个语句的功能、试数
3. 看懂之后尝试自己去修改程序，并且知道修改之后程序的输出结果，不建议看懂程序之后立即自己敲程序
4. 照着答案去敲
5. 调试错误
6. 不看答案，自己独立把答案敲出来
7. 如果程序实在无法彻底理解，就把它背会，不过无法彻底理解的程序，很少